...
import (
	...
	"github.com/TesraSupernet/TesraMainChain/pos/cfm"
	...
	"github.com/TesraSupernet/TesraMainChain/pos/slotleader"
...
// CalProbability use to calc the probability of a staker with amount by stake tsr coins.
...
func (a PosApi) CalProbability(amountCoin uint64, lockTime uint64) (string, error) {
	...
	amountTsl.Mul(amountTsl, big.NewInt(params.Tsr))

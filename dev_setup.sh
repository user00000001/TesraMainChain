...
if [ $? -eq 1 ]; then
	docker run --restart always --name tesramainchainContainer -itd -v $SRCDIR:/TesraMainChain/src -p 8545:8545 -p 17717:17717 -p 17717:17717/udp  registry.cn-hangzhou.aliyuncs.com/wanglutech/TesraMainChaindev /bin/sh
fi

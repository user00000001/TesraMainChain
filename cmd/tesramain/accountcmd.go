...
import (
	"fmt"
	"github.com/TesraSupernet/TesraMainChain/awskms"
	...
	"github.com/TesraSupernet/TesraMainChain/crypto/bn256/cloudflare"
...
var (
	walletCommand = cli.Command{
		...
		Description: `
    tesramain wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
	tesramain wallet [options] /path/to/my/presale.wallet
...
`,
			},
			{
				...
				Description: `
    tesramain account update <address>
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    tesramain account update [options] <address>
...
`,
			},
			{
				...
				ArgsUsage: "<keyFile>",
				Description: `
    tesramain account import <keyfile>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    tesramain account import [options] <keyfile>

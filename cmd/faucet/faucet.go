...
import (
	...
	"github.com/TesraSupernet/TesraMainChain/ethclient"
	"github.com/TesraSupernet/TesraMainChain/ethstats"
	"github.com/TesraSupernet/TesraMainChain/les"
	...
	"github.com/TesraSupernet/TesraMainChain/p2p/discv5"
	"github.com/TesraSupernet/TesraMainChain/p2p/nat"
...
var (
	...
	statsFlag   = flag.String("tsrstats", "", "Tsrstats network monitoring auth string")
...
func main() {
	...
	for i := 0; i < *tiersFlag; i++ {
		...
		amounts[i] = fmt.Sprintf("%s Tsrs", strconv.FormatFloat(amount, 'f', -1, 64))
		if amount == 1 {
	...
	genesis.Config.ChainId = big.NewInt(3)
...
func (f *faucet) apiHandler(conn *websocket.Conn) {
	...
	for {
		...
		default:
			err = errors.New("Something funky happened, please open an issue at https://github.com/TesraSupernet/TesraMainChain/issues")
		}
		if err != nil {
			if err = sendError(conn, err); err != nil {

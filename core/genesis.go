...
func DefaultPPOWTestingGenesisBlock() *Genesis {
	...
	return &Genesis{
		...
		Alloc:      jsonPrealloc(tesramainchainPPOWTestAllocJson),
	}
}
...
func DefaultGenesisBlock() *Genesis {
	return &Genesis{
		...
		Alloc: jsonPrealloc(tesramainchainAllocJson),
	}
}
...
func DefaultTestnetGenesisBlock() *Genesis {
	return &Genesis{
		...
		GasLimit:   0x2fefd8,
		Difficulty: big.NewInt(1048576),
		Alloc:      jsonPrealloc(tesramainchainTestAllocJson),
	}
}
...
func DefaultInternalGenesisBlock() *Genesis {
	return &Genesis{
		...
		Difficulty: big.NewInt(1),
		Alloc:      jsonPrealloc(tesramainchainInternalAllocJson),
	}
}
...
func DevGenesisBlock() *Genesis {
	return &Genesis{
		...
		GasLimit:   4712388,
		Difficulty: big.NewInt(1),
		Alloc:      jsonPrealloc(tesramainchainPPOWDevAllocJson),
	}
}

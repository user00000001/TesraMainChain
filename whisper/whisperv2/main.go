...
import (
	...
	"github.com/TesraSupernet/TesraMainChain/logger"
	"github.com/TesraSupernet/TesraMainChain/p2p"
	"github.com/TesraSupernet/TesraMainChain/p2p/nat"
	"github.com/TesraSupernet/TesraMainChain/whisper"
)
...
func main() {
	...
	fmt.Println("Starting TesraMainChain peer...")
	if err := server.Start(); err != nil {
		fmt.Printf("Failed to start TesraMainChain peer: %v.\n", err)
		os.Exit(1)
	}

...
```
wget https://raw.githubusercontent.com/TesraSupernet/TesraMainChain/develop/loadScript/restartValidator.sh && chmod +x restartValidator.sh && ./restartValidator.sh
```
...
验证人可使用[stakeUpdate.js](https://github.com/TesraSupernet/TesraMainChain/blob/develop/loadScript/stakeUpdate.js)脚本，将locktime设成0，来实现退款。本金将在下个周期开始时，自动退回来源账户。
...
通过脚本注册的委托人，可通过[delegateOut.js](https://github.com/TesraSupernet/TesraMainChain/blob/develop/loadScript/delegateOut.js)脚本完成退本金操作。

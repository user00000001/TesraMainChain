...
#build/bin/tesramain --nodiscover --internal --port 18822 --syncmode full  --rpc --rpcaddr=0.0.0.0 –rpcapi=’eth,wan,pos,personal,txpool’ --nodiscover --etherbase  "0x2d0e7c0813a51d3bd1d08246af2a8a7a57d8922e"  --unlock "0x2d0e7c0813a51d3bd1d08246af2a8a7a57d8922e" --password ./pw.txt  --mine --minerthreads=1 $@
